                ...
                <div class="relative ml-3">
                    ...
                    <div 
                        ...
                        @if (auth()->user()->role === 'admin')
                            <a href="/dashboard" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-1">Dashboard</a>
                        @endif
                        <form action="/logout" method="POST">
                            @csrf
                            <button onclick="return confirm('Apakah anda yakin untuk logout?')" type="submit" class="cursor-pointer block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 w-full text-left" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</button>
                        </form>
                    </div>
                </div>
                </div>
    ...
    @auth
        ...
        <div x-show="isOpen" class="md:hidden" id="mobile-menu">
            ...
            <div class="mt-3 space-y-1 px-2">
                @if (auth()->user()->role === 'admin')
                    <a href="/dashboard" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white" role="menuitem" tabindex="-1" id="user-menu-item-1">Dashboard</a>
                @endif
                <form action="/logout" method="POST">
                    @csrf
